  ...
  const data = {
    ...
    Earth-transport: `
      ...
      <div class="yellow-block">
        ...
        <ul>
          <li>Зенітний ракетний комплекс.</li>
          <li>Стандартний тип боєприпасу: Air 1A.</li>
          <li>Всього боєприпасів: 8.</li>
          <li>Скорострільність: 1 ракета/1.5с.</li>
          <li>Час перезарядки: 7.5с.</li>
          <li>Радіус дії: 80 Од.(640px).</li>
          <li>Підтримує боєприпаси: Air 1A, Air 1B.</li>
        </ul>
      </div>
